...
//                         `---------------------------------------'  `---------------------------------------'
  [_CONF] = LAYOUT(
    ...
    M_E3, M_B3,  RGB_SAD, RGB_HUD, RGB_MOD,   RESET, KC_POWER, KC_TRNS,   KC_TRNS, KC_TRNS,   RESET, _______, _______, _______, _______, KC_CAPS,
...
//                         `---------------------------------------'  `---------------------------------------'
  [_NAVI] = LAYOUT(
    KC_TRNS, KC_F13, KC_F14,  KC_F15,  KC_F16, _______,                                       _______, KC_HOME,   KC_UP, KC_PGUP, _______, KC_TRNS,
    KC_TRNS, KC_F17, KC_F18,  KC_F19,  KC_F20, _______,                                       _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,
...
// |       |  ⇉ â  |  ⇉ à  |  ⇉ ä  |  ⇉ á  |  ⇶ €  |                                  |       |  F1   |  F2   |  F3   |  F4   |   ▼   |
// |-------+-------+-------+-------+-------+-------|                                  |-------+-------+-------+-------+-------+-------|
// |   ▼   |   1   |   2   |   3   |   4   |   5   |                                  |       |  F5   |  F6   |  F7   |  F8   |       |
// |-------+-------+-------+-------+-------+-------+---------------.  ,---------------+-------+-------+-------+-------+-------+-------|
// |       |   6   |   7   |   8   |   9   |   0   |   ▼   |   ▼   |  |   ▼   |   ▼   |       |  F9   |  F10  |  F11  |  F12  |       |
// `-----------------------+-------+-------+-------+-------+-------|  |-------+-------+-------+-------+-------+-----------------------'
//                         |       |       |       |       |       |  |       |       |       |       |       |
//                         |   ▼   |   ▼   |   ▼   |   ▼   |   ▼   |  |   ▼   |   ▼   |   ▼   |   ▼   |   ▼   |
//                         `---------------------------------------'  `---------------------------------------'
  [_NUMB] = LAYOUT(
    _______, C_CIRCU, C_GRAVE, C_TREMA, C_ACUTE,   C_EUR,                                       _______,   KC_F1,  KC_F2,  KC_F3,  KC_F4, KC_TRNS,
    KC_TRNS,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                                       _______,   KC_F5,  KC_F6,  KC_F7,  KC_F8, _______,
    _______,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_TRNS, KC_TRNS,   KC_TRNS, KC_TRNS, _______,   KC_F9, KC_F10, KC_F11, KC_F12, _______,
                               KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
  ),
...
//                         `---------------------------------------'  `---------------------------------------'
  [_SYMB] = LAYOUT(
    _______, KC_QUES, KC_BSLS, KC_PIPE, KC_SLSH, KC_COMP,                                       _______,   KC_LT,  KC_EQL, KC_UNDS,   KC_GT, KC_TRNS,
    KC_TRNS, KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_PERC,                                       KC_LCBR, KC_LBRC, KC_LPRN, KC_RPRN, KC_RBRC, KC_RCBR,
    _______, KC_CIRC, KC_AMPR, KC_ASTR,  KC_GRV, KC_TILD, KC_TRNS, KC_TRNS,   KC_TRNS, KC_TRNS, KC_MINS, KC_DQUO, KC_SCLN, KC_COLN, KC_QUOT, KC_PLUS,
                               KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
  ),
...
// |-------+-------+-------+-------+-------+-------|                                  |-------+-------+-------+-------+-------+-------|
// |  Esc  |   a   |   s   |   d   |   f   |   g   |                                  |   h   |   j   |   k   |   l   |  Tab  | Enter |
// |-------+-------+-------+-------+-------+-------+---------------.  ,---------------+-------+-------+-------+-------+-------+-------|
// |       |   z   |   x   |   c   |   v   |   b   | Lock  | ▲Conf |  | ▲Conf | ▲Mouse|   n   |   m   |   ,   |   .   | S-Tab |  Del  |
// `-----------------------+-------+-------+-------+-------+-------|  |-------+-------+-------+-------+-------+-----------------------'
//                         |       |       |       |       |       |  |       |       |       |       |       |
...
//                         `---------------------------------------'  `---------------------------------------'
  [_BASE] = LAYOUT(
    _______, KC_Q, KC_W,   KC_E,       KC_R,       KC_T,                                                 KC_Y,    KC_U,     KC_I,   KC_O,      KC_P, KC_BSPC,
     KC_ESC, KC_A, KC_S,   KC_D,       KC_F,       KC_G,                                                 KC_H,    KC_J,     KC_K,   KC_L,    KC_TAB,  KC_ENT,
    _______, KC_Z, KC_X,   KC_C,       KC_V,       KC_B, G(KC_L),  MO(_CONF),   MO(_CONF), TG(_MOUS),    KC_N,    KC_M, KC_COMMA, KC_DOT, S(KC_TAB),  KC_DEL,
